...
$expectedUsers = @(
    @{Username="amy.porter";   Group="GRP_IT"},
    @{Username="joe.meyer";    Group="GRP_Finance"},
    @{Username="chloe.sanders";Group="GRP_Finance"},
    @{Username="marcus.webb";  Group="GRP_HR"},
    @{Username="kim.cole";     Group="GRP_Sales"})
