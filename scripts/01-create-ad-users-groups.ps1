...
$users = @(
    @{First="Amy";   Last="Porter";  Username="amy.porter";   Group="GRP_IT"      },
    @{First="Joe";    Last="Meyer";   Username="joe.meyer";    Group="GRP_Finance" },
    @{First="Chloe";  Last="Sanders"; Username="chloe.sanders";Group="GRP_Finance" },
    @{First="Marcus"; Last="Webb";    Username="marcus.webb";  Group="GRP_HR"      },
    @{First="Kim";    Last="Cole";    Username="kim.cole";     Group="GRP_Sales"   }
)
